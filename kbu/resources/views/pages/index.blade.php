...
@section('title', 'KBU')
@section('content')
    <div class="container-grid bg-content-size-container">
        <video class="content-size-video" muted="" loop="loop" autoplay="">
            <source src="./im/1.mp4" type="video/mp4">
        </video>
        <h1 class="heading-10">Votre université d'&nbsp;<br>EXCELLENCE</h1><a href="#"
            class="responsive-picture picture-link-1">
            <picture><img alt="Placeholder Picture" src="./im/next-3%402x.png"></picture>
        </a>
    </div>
    <h3 class="heading-14">Lequel des profils vous correspond au mieux ?</h3>
    ...
    <div class="container-grid container-75">
        <div class="container-grid container-99 ind1">
            ...
            <p class="paragraph paragraph-8">Si vous avez obtenu un BAC ou une&nbsp;LICENCE et vous désirez étudier à temps
                plein. <br></p>
        </div>
