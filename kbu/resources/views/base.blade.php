...
<head>
    ...
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Literata:400,i">
...
<body class="body-2">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                        ...
                        <div class="navbar-nav">
                            ...
                            <a class="nav-link" href="{{ route('programme') }}">Programmes</a>
                            <a class="nav-link" href="{{ route('admission') }}">Admission</a>
                            <a class="nav-link" href="{{ route('frais') }}">Frais</a>
                            <a class="nav-link" href="{{ route('bourse') }}">Bourses</a>
                            <a class="nav-link" href="{{ route('departement') }}">Département</a>
                        </div>
    ...
    <main class="container-grid container-15">
        @yield('content')
        ...
        <footer>
            <div class="row">
                ...
                <div class="col-12">
                    <a href="{{ route('fab') }}"> <button> S'abonner</button></a>
                </div>
            </div>
            <div class="row">
                <div class="col-md-3">
                    ...
                    <ul style="list-style-type : none;">
                        <li><a href="#"><i class="fas fa-map-marker-alt me-2 p-1 bg-white rounded-circle"
                                    style="color:#30110D;"></i>300 BP 40 ,Sokodé,Togo</a></li>
                        <li><a href="#"><i class="fas fa-phone me-2 p-1 bg-white rounded-circle"
                                    style="color:#30110D;"></i>+1 613 908-5283 / +228 93 53 38 91</a></li>
                        <li><a href="#"><i class="fas fa-envelope me-2 p-1 bg-white rounded-circle"
                                    style="color:#30110D;"></i>contact@knowbridge.com</a></li>
                    </ul>

                    <a href="#"><i class="fab fa-telegram me-2 p-1 bg-white rounded-circle"
                            style="color:#30110D;"></i></a>
                    <a href="#"><i class="fab fa-facebook me-2 p-1 bg-white rounded-circle"
                            style="color:#30110D;"></i></a>
                    <a href="#"><i class="fab fa-instagram me-2 p-1 bg-white rounded-circle"
                            style="color:#30110D;"></i></a>
                    <a href="#"><i class="fab fa-linkedin me-2 p-1 bg-white rounded-circle"
                            style="color:#30110D;"></i></a>
                    <a href="#"><i class="fab fa-twitter me-2 p-1 bg-white rounded-circle"
                            style="color:#30110D;"></i></a>
                    <a href="#"><i class="fab fa-youtube me-2 p-1 bg-white rounded-circle"
                            style="color:#30110D;"></i></a>

                    <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="choisissez votre demande d'études"
                            aria-label="Recipient's username" aria-describedby="basic-addon2">
                        <span class="input-group-text text-white" style="background-color: #30110D;">Appliquer
                            maintenant</span>
                    </div>
                ...
                <div class="col-md-3">
                    ...
                    <ul style="list-style-type: disc;">
                        ...
                        <li><a href="{{ route('stage') }}">Stages et emplois</a></li>
                ...
                <div class="col-md-3">
                    ...
                    <ul style="list-style-type: disc;">
                        ...
                        <li><a href="{{ route('frais') }}">Frais</a></li>
                        <li><a href="{{ route('bourse') }}">Bourses</a></li>
                ...
                <div class="col-md-3">
                    <h5>Liens utiles</h5>
                    <ul style="list-style-type: disc;">
                        <li><a href="{{ route('professeur') }}">Portail professeurs </a></li>
                        <li><a href="{{ route('carriere') }}">Carrières</a></li>
                        <li><a href="{{ route('partenaire') }}">Nos
                                partenaires</a></li>
                        <li><a href="#">Embaucher
                                un étudiant</a></li>
                        <li><a href="#">FAQ</a></li>
